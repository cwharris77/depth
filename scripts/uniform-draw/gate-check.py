...
NOTES = {
    ...
    "jets": "the fetched oval Jets lockup is a 1.67-aspect flat mark, while the helmet wordmark "
            "is about 3.39 aspect. Trace the four white wordmark components from the standalone "
            "mark and use the internal uniform composite only for placement; see scripts/"
            "uniform-draw/jets_wordmark.py.",
}
