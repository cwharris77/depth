...
# (house convention for scripts -- see the vault's `Reference/espn.md`, web/scripts/vercel-ignore-build.sh) so
...
#   scripts/inspect-archive-secrets.sh --self-test   # fast matcher unit test, no build required
