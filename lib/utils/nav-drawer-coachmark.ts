...
// Mirrors lib/utils/ios-install-hint.ts's storage-wrapper shape: reads/writes are wrapped because
...
import { STORAGE_KEY_DEPTH_NAV_DRAWER_DISMISSED } from '@/lib/utils/storage-keys';
