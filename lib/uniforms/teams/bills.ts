...
// Buffalo's modern uniform construction. Fixed decal and band colors remain literal brand values;
// kit body colors still resolve from the runtime TeamColors supplied by the roster/archive data.
