// Cincinnati's construction geometry — the tiger-stripe paths only. The composable parts
// definition that consumes them lives in ./bengals.parts.ts; the former flat BENGALS_UNIFORMS
