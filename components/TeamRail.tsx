...
// to their roster page via `?player=` (SyncSelectionFromQuery opens the card there), which
...
export default function TeamRail({
  ...
  // page where SyncSelectionFromQuery opens the card, which behaves identically from the
