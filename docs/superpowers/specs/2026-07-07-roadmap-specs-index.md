...
| **C — Custom rosters** | 🟡 v0 shipped (depth#41 localStorage reorder, depth#55 `?order=` share) | Auth pass 1 (accounts + per-user settings, account-gated): [`2026-07-09-auth-account-and-user-settings-design.md`](2026-07-09-auth-account-and-user-settings-design.md). Remainder (override sync, share-by-reference, full RLS): [`2026-07-07-phase-c-auth-and-saved-boards-design.md`](2026-07-07-phase-c-auth-and-saved-boards-design.md) |
...
| **E — Vision features** | 🟡 coach + season stats page shipped (depth#95), multi-season stats + season-scoped coach shipped, real per-team formations shipped | Five independent specs:<br>• [`2026-07-07-phase-e-coaches-design.md`](2026-07-07-phase-e-coaches-design.md) → superseded (display) by [`2026-07-12-team-stats-page-design.md`](2026-07-12-team-stats-page-design.md), extended by [`2026-07-14-multi-season-team-stats-design.md`](2026-07-14-multi-season-team-stats-design.md), coach display corrected by [`2026-07-14-season-scoped-head-coach-design.md`](2026-07-14-season-scoped-head-coach-design.md)<br>• [`2026-07-07-nflverse-ingestion-and-player-stats-design.md`](2026-07-07-nflverse-ingestion-and-player-stats-design.md) (player stats — also the scaffolding D/E build on)<br>• [`2026-07-07-phase-e-contracts-design.md`](2026-07-07-phase-e-contracts-design.md)<br>• [`2026-07-07-phase-e-draft-boards-design.md`](2026-07-07-phase-e-draft-boards-design.md)<br>• [`2026-07-07-phase-e-real-formations-design.md`](2026-07-07-phase-e-real-formations-design.md) → ✅ shipped<br>• [`2026-07-07-phase-e-play-diagrams-design.md`](2026-07-07-phase-e-play-diagrams-design.md) |
...
| **Team schedule (SCHEDULE tab) + next game** | ✅ shipped — SCHEDULE tab (PR2 UI) + NEXT GAME card live; past-season browsing shipped as the season-picker addendum | [`2026-07-17-team-schedule-design.md`](2026-07-17-team-schedule-design.md) — nflverse `games.csv` → new `schedules`+`games` tables (PR1 data) → SCHEDULE route + NEXT GAME card + enabled tab (PR2 UI). Vault ticket "Add team schedules page" · Season picker (browse 1999–present on the stored data): [`2026-08-10-past-season-schedule-view-design.md`](2026-08-10-past-season-schedule-view-design.md) |
