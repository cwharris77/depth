    ...
    @Suite struct DepthSnapshotTests {
        ...
        @Test func depthChartFieldOffense() async throws {
            ...
            assertSnapshot(
                of: DepthChartFieldView(
                    snapshot: snapshot, unit: .offense, onSelectPlayer: { _ in }),
        ...
        @Test func depthChartFieldDefense() async throws {
            ...
            assertSnapshot(
                of: DepthChartFieldView(
                    snapshot: snapshot, unit: .defense, onSelectPlayer: { _ in }),
                as: .image(perceptualPrecision: 0.98, layout: .fixed(width: 393, height: 760))
            )
        }
        ...
        @Test func depthChartFieldSpecialTeams() async throws {
            ...
            assertSnapshot(
                of: DepthChartFieldView(
                    snapshot: snapshot, unit: .special, onSelectPlayer: { _ in }),
                as: .image(perceptualPrecision: 0.98, layout: .fixed(width: 393, height: 760))
            )
        }
        ...
        @Test func positionReorderSheet() async throws {
            ...
            assertSnapshot(
                of: PositionReorderSheet(
                    position: .qb, players: quarterbacks, defaultOrder: quarterbacks,
                    isCustom: false,
        ...
        @Test func positionReorderSheetCustom() async throws {
            ...
            assertSnapshot(
                of: PositionReorderSheet(
                    position: .qb, players: Array(quarterbacks.reversed()),
                    defaultOrder: quarterbacks,
                    isCustom: true, highlightedPlayerID: starter.id,
