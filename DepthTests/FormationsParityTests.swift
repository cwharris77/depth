...
// Parity tests against web/fixtures/domain/*.json, generated from the TS oracle
// (web/lib/utils/depth-chart/formations.ts, web/lib/utils/roster/roster.ts). Every case here
