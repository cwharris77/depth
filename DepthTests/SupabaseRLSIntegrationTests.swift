...
// distinction (web/supabase/migrations/20260710140000_base_table_rls.sql: one policy per
...
enum LocalSupabase {
    ...
    // xcconfig's SUPABASE_PUBLISHABLE_KEY. Local-only demo value `supabase start`
    ...
    // gitignored local file instead: create `.local-service-role-key` at the repo root
