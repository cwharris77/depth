...
// Native equivalent of web/components/ui/Card.tsx — the one
...
extension View {
    ...
    ///
    /// `padded: false` skips the outer padding for row-list content whose
    ...
    /// (16) for surfaces that must match web's `rounded-2xl` cards.
    func depthCard(
