...
struct DepthChartFieldLayout: Equatable {
    ...
    /// Web parity (web/components/PlayerDot.tsx `LABEL_VISIBILITY`): whether a unit's player
    ...
    /// Web parity (web/components/PlayerDot.tsx): an on-line dot is nudged a radius onto its
