...
// web/supabase/migrations' actual column names (verified against local Supabase, not
...
// A flat uniform row for the archive's listUniforms read (mirrors web/lib/roster-source.db.ts
