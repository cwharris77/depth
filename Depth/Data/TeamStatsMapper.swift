...
// the season-state block of `fetchTeamStatsPage` (web/lib/roster-source.db.ts:622-647): a
...
enum TeamStatsMapper {
    ...
    /// Swift port of web/lib/utils/team/nfl-season.ts's `nflSeasonState()` — the NFL season
