...
// Direct Swift port of web/lib/utils/depth-chart/formations.ts. The TS file is the oracle —
// this must match it exactly, verified by the shared fixtures under web/fixtures/domain/
// (DepthTests/FormationsParityTests.swift). Keep in lockstep: when formations.ts
// changes, regenerate fixtures (`npx tsx web/fixtures/generate.mts` in web/) and
...
// rosters carry no side/role tags at all (web/lib/nflverse/positions.ts collapses every end
...
/// the default pick, mirroring web's `topFormationFor` in web/lib/hooks/depth-chart/use-formations.ts.
