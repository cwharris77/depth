...
// Mirrors web/lib/types.ts's TeamColors — the three colors that describe a real jersey.
//
...
// Mirrors web/lib/types.ts's Team.
...
// Mirrors web/lib/types.ts's UniformKind.
...
// Mirrors web/lib/types.ts's Uniform.
...
// Mirrors web/lib/types.ts's TeamFormation — one real FTN-charted formation a team ran for a
...
// formations. Mirrors web/lib/types.ts's TeamRoster (which carries TeamFormation[] alongside
