...
// Mirrors web/lib/utils/team-surfaces.ts exactly. The single place a team's colors are matched
...
// web/fixtures/domain/team-surfaces.json, which covers all 105 kits. Change one side and the
// other fails; regenerate with `npx tsx web/fixtures/generate.mts` (in web/) when the rule changes.
//
