...
private func fullMetrics(
    ...
    TeamMatchupMetrics(
        ...
        offensiveEPAPerPlay: offensiveEPAPerPlay, passingInterceptions: passingInterceptions,
        fumblesLost: fumblesLost, giveaways: giveaways, defensiveSacks: defensiveSacks,
...
@Test func aGroupWithNoResolvableRowsIsDroppedEntirely() {
    ...
    let empty = TeamMatchupMetrics(
        ...
        passingInterceptions: nil, fumblesLost: nil, giveaways: nil, defensiveSacks: nil,
