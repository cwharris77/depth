...
//   ../Depth/LaunchMark.png (540)  — native launch-screen mark (repo root; local storyboard image)
//
...
// directly on the #0A0E1A LaunchBackground. Written as a single 540px PNG that ships
// beside LaunchScreen.storyboard (a local storyboard image — ibtool/launch loading can't
// resolve asset-catalog `catalog="main"` images in launch screens here) and is bundled at
// the app root; the storyboard's centered 180pt UIImageView downscales it crisply.
...
await write(launchMark(540), 540, join(root, '../Depth/LaunchMark.png'));
