...
// shared_boards), the iOS-only analytics counters
// (Depth/Support/AppEventsRecorder.swift), and the IP-keyed search rate limiter
...
//
// IMPORTANT: the analytics section is not optional garnish — Depth/PrivacyInfo.xcprivacy
