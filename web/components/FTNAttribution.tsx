...
// FTN charting (the nflverse pbp_participation dataset) requires this one-line
// attribution wherever formation data is surfaced. Shared by every surface that shows
