// nflverse release assets are plain CSV files attached to tagged GitHub releases — one tag per
// dataset (`players`, `player_stats`, `rosters`, ...). No API, no auth: a predictable URL per (tag,
// file).
