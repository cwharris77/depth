// Launch gates, as Vercel Flags SDK flags. Flags are evaluated
...
// 2026-07-17 specifically to let /team/[id] prerender again; check static
// generation still holds before adding a new one.
