...
// to 'DE', backer to 'LB', safety to 'S') and a past season has no formation rows to
// swap in a real front, so all 11 dots resolved to nothing and the defense rendered
// empty. preferredPosition keeps a granularly-tagged roster seating exactly as before.
...
// first (#568, lbY in Depth/Domain/Formations.swift) but only on its own side, which
